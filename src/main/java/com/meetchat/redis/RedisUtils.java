...
public class RedisUtils<V> {
     ...
     *
     * @param key 键
     * @return 递减后的值，异常返回null
     */
    public Long decr(String key) {
        try {
            return redisTemplate.opsForValue().increment(key, -1);
        } catch (Exception e) {
            logger.error("decr失败: key={}", key, e);
            return null;
        }
    }
